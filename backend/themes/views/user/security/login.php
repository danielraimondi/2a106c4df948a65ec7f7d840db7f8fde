    ...
    <div class="login-box-body">
        ...
        <?php ActiveForm::end(); ?>
         ...
         <div class="social-auth-links text-center">
            ...
            <a href="https://test-danielraimondi.c9.io/relevando/backend/web/user/security/auth?authclient=google" class="btn btn-block btn-social btn-google-plus btn-flat"><i class="fa fa-google-plus"></i> Sign
                in using Google+</a>
        </div>
        <!-- /.social-auth-links -->
